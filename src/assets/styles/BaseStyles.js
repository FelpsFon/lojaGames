export const colors = {
  ...
  // For button disabled effect
  disabledButtonBackgroundColor: '#CCCCCC',
  disabledButtonColor: '#666666',
  disableTextColor: '#AAAAAA',

  // padronização das cores do Fortuna
  green100: '#E5FAF5',
  green200: '#BFF2E5',
  green300: '#8CE8D1',
  green400: '#4CDBB8',
